...
/**
 * Servlet implementation class verificationfromcenter
 */
public class verificationfromcenter extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public verificationfromcenter() {
        super();
...
//		doGet(request, response);
        ...
        String donstatus = request.getParameter("donationstatus");
        ...
        try {
        		...
        		String query = "update donor set donationstatus = '"+donstatus+"' where id = '"+id+"';";
        		 ...
        		 out.print("<html>\r\n" + 
     					...
     					"<h3 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">Click on the Image To Go Back</h3><center><a href=\"CenterDashboard.jsp\">\r\n" + 
        	...
        	out.print("<html>\r\n" + 
					...
					"<h3 style=\"color:white ; border: 2px solid white; font-size:100%;\">Click on the Image To Go Back</h3><a href=\"CenterDashboard.jsp\">\r\n" + 
