...
/**
 * Servlet implementation class ValidateCenter
 */
public class ValidateCenter extends HttpServlet {
	...
	result = "User Verified !!";
		...
		try {
			...
			out.print("<html>\r\n" + 
					...
					"<h3 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">Click on the Image To Proceed Furthur</h3><center><a href=\"CenterDashboard.jsp\">\r\n" + 
