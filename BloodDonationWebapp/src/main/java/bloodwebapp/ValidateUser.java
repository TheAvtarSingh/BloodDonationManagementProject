...
String feedback = "";
while(records1.next()) {
	String email = records1.getString(2);
	String pwd = records1.getString(3);
...
if(newVisitor == true) {
			...
			try {
				...
				out.print("<html>\r\n" + 
						...
						"<body>\r\n" + 
						"\r\n" +
						"<div><h1 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">-------"+greet+"-------- </h1><center>\r\n" + 
						...
						"<h3 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">Click on the Image To Proceed Furthur</h3><center><a href=\"UserRegistration.jsp\">\r\n" + 
			...
			try {
				...
				out.print("<html>\r\n" + 
						...
						"<h1 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">------- Verifying Credentials -------- </h1><center>\r\n" + 
						"<h2 style=\\\"color:white ;text-align:center; border: 2px solid white; font-size:500%;\\\">User Found in Our DataBase . Now You can Proceed Further</h2><center> "+
						"<h3 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">Click on the Image To Proceed Furthur</h3><center><a href=\"UserDashboard.jsp\">\r\n" + 
						"         <img alt=\"Back Button\" src=\"https://png.pngtree.com/png-vector/20190120/ourmid/pngtree-forward-vector-icon-png-image_470299.jpg\"\r\n" + 
						"          width=40\" height=\"40\"></a></center></div></body>\r\n" + 
						"</html>\r\n" + 
						"");	
		...
		System.out.println();
		feedback = "Redirecting To Main Page";
...
//		response.sendRedirect("index.jsp");
	...
	if (count==0) {
		...
		out.print("<html>\r\n" + 
				...
				"<body>\r\n" + 
				"\r\n" +
				"<h1 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">-------"+greet+"-------- </h1><center>\r\n" + 
				...
				"<h3 style=\"color:white ; border: 2px solid white; font-size:100%;\">Click on the Image To Go Back</h3><a href=\"welcome.jsp\">\r\n" + 
