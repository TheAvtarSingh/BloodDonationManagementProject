...
//		doGet(request, response);
		...
		String url = "jdbc:mysql://localhost/admindb";
		...
		String readQuery = "select *from records";
	...
	result = "Admin Verified !!";
		...
		try {
			...
			out.print("<html>\r\n" + 
					...
					"<h3 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">Click on the Image To Proceed Furthur</h3><center><a href=\"admindashboard.jsp\">\r\n" + 
					"         <img alt=\"Proceed\" src=\"https://png.pngtree.com/png-vector/20190120/ourmid/pngtree-forward-vector-icon-png-image_470299.jpg\"\r\n" + 
