...
//		doGet(request, response);
		...
		System.out.println("Password : "+username1);
		
		System.out.println("------- Verifying Credentials -------- ");
		String readQuery = "select *from centerlogin";
		String countQuery = "select count(*) from centerlogin";
...
while(records1.next()) {
	...
	String pass = records1.getString(4);
//	System.out.println(email+" "+password);
if(name.equals(email) && username1.equals(pwd)){
	result = "User Verified !!";
		...
		try {
			...
			out.print("<html>\r\n" + 
					...
					"<h2 style=\\\"color:white ;text-align:center; border: 2px solid white; font-size:500%;\\\">User Found in Our DataBase . Your Password is : "+pass+"</h2><center> "+
					"<h3 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">Click on the Image To Proceed Furthur</h3><center><a href=\"CenterLogin.jsp\">\r\n" + 
...
//		response.sendRedirect("index.jsp");
	...
	if (count==0) {
		...
		out.print("<html>\r\n" + 
				...
				"<h3 style=\"color:white ; border: 2px solid white; font-size:100%;\">Click on the Image To Go Back</h3><a href=\"CenterLogin.jsp\">\r\n" + 
