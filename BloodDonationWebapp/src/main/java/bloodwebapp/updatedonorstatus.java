...
/**
 * Servlet implementation class updatedonorstatus
 */
...
//		doGet(request, response);
        ...
        try {
        		...
        		String query = "update donor set bgroup = '"+grp+"',donationstatus = '"+donstatus+"',usedstatus = '"+usedstatus+"' where id = '"+id+"';";
        		 ...
        		 out.print("<html>\r\n" + 
     					...
     					"<h3 style=\"color:white ;text-align:center; border: 2px solid white; font-size:300%;\">Click on the Image To Go Back</h3><center><a href=\"admindashboard.jsp\">\r\n" + 
